 ...
 *
 * This is the second version of the CUDA Jacobi Kernel
 * This version of the kernel uses the CUDA API to calculate optimal block and grid sizes
 * The block and grid size is important to ensure maximum processor efficiency.
 */
