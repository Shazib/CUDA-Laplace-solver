 ...
 *
 * This is the third version of the Jacobi kernel
 * This version of the kernel changes double data types to floats and these are expected to perform better
 * Although this only provides a small speedup, as the size of the problem grows it will be helpful
 */
